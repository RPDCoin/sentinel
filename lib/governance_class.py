...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to rapidd "gobject list" output
    ...
    def rapidd_serialise(self):
        import rapidlib
        return rapidlib.SHIM_serialise_for_rapidd(self.serialise())
